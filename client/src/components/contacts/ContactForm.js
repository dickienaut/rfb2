...
const ContactForm = () => {
  ...
  return (
    <form onSubmit={onSubmit}>
      <h2 className="text-primary">{(contact.name === '') ? 'Add Contact' : 'Edit Contact'}</h2>
      ...
      <div>
        <input className="btn btn-primary btn-block" type='submit' value={!current ? 'Add Contact' : 'Edit Contact'} />
      </div>
      {current && (
        <div>
